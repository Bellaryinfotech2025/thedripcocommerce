 ...
 *
 * @param {string} validateUrlPrefix - e.g. "https://api.thedripco.store/api/v2"
 * @returns {Promise<boolean>}
 */
export const checkLoginStatus = async (validateUrlPrefix = "https://api.thedripco.store/api/v2") => {
