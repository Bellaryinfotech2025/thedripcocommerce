...
const PaymentForm = ({
  ...
  const createRazorpayOrder = async () => {
    try {
      ...
      const response = await fetch("https://api.thedripco.store/api/payments/create-order", {
        method: "POST",
    ...
    try {
      ...
      const options = {
        ...
        handler: async (response) => {
          ...
          try {
            const verifyResponse = await fetch("https://api.thedripco.store/api/payments/verify-payment", {
              method: "POST",
              headers: { "Content-Type": "application/json" },
              body: JSON.stringify({
